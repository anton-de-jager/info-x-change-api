...
namespace infoX.api.Controllers
{
    ...
    public class DocumentUploadController : ControllerBase
    {
        ...
        public DocumentUploadController(PegasusDataWarehouseDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                ...
                var records = await _context.DocumentUpload
                    .FromSqlRaw("SELECT * FROM documentUpload WHERE CompanyID = " + companyId)
                    .ToListAsync();
